...
// import React from 'react';
// import { userDetailsArray } from './login'; // Import the stored logins
// import { useNavigate } from 'react-router-dom';
...
//     return (
//       <div className='bg-[url("https://staticg.sportskeeda.com/editor/2024/05/1b46d-17146683980276-1920.jpg")] bg-cover h-screen w-screen mr-24 flex justify-start items-center  '>    
//         <div className='px-[40px] py-6 bg-white border-solid border-[#000000] mr-[100px] h-80 ml-24 w-1/3 overflow-y-auto no-scrollbar scroll-smooth '>
...
//                    <button 
//                    onClick={() => navigate('/', { state: { user } })}>Edit</button>
//                   </div>
...
//   return (
//     <div className='bg-[url("https://staticg.sportskeeda.com/editor/2024/05/1b46d-17146683980276-1920.jpg")] bg-cover h-screen w-screen flex justify-start items-center overflow-auto '>    
//       {/* <div className='px-[40px] py-6 bg-white rounded-[30px] border-solid border-2 border-[#000000] mr-[100px] overflow-y-auto h-80'> */}
...
//                  <button className='ml-44 '>Edit</button>
...
//   return (
//     <div className='bg-[url("https://staticg.sportskeeda.com/editor/2024/05/1b46d-17146683980276-1920.jpg")] bg-cover h-screen w-screen flex justify-start items-center'>    
//       <div className='px-[40px] py-6 bg-white rounded-[30px] border-solid border-2 border-[#000000] mr-[100px]'></div>
